package com.we4sley.management.product.controller;

import com.we4sley.common.SearchCondition;
import com.we4sley.management.product.model.dto.ProductDTO;
import com.we4sley.management.product.model.service.ProductService;
import com.we4sley.management.product.view.ProductPrint;
...
public class ProductController {
    ...
    public void selectProductByCondition(SearchCondition searchCondition) {
        ...
        if (productList != null && !productList.isEmpty()) {
            ...
            productPrint.printErrorMessage("selectListByCondition");
        }
